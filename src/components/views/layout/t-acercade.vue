<template>
  <div class="h-screen" :style="{ backgroundImage: 'url(//unpkg.com/three-globe/example/img/night-sky.png)', backgroundSize: 'cover', backgroundPosition: 'center' }">
    ...
    <div v-if="!showContent" class="absolute inset-0 flex justify-center items-center">
      <img
...
onMounted(() => {
  setTimeout(() => {
    ...
    setTimeout(() => {
      showContent.value = true; // Muestra el contenido al completar el zoom
    }, 2000); // Sincroniza el tiempo con el efecto de zoom
