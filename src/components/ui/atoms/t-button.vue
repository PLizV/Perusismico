<template>
  <component
    class="btn no-underline font-medium flex items-center cursor-pointer border shadow hover:shadow-lg focus:outline-none focus:shadow-outline"
    :is="buttonType"
    :href="href"
    :type="type"
    :class="btnClasses"
  ...
  computed: {
    colorClasses() {
      const colorMappings = {
        ...
        blue: "bg-igp-sky-blue-700 text-igp-white",
